             ...
             sidebarLayout(
               sidebarPanel(
                 ...
                 tags$div(style = "display:none;",
                          textInput("file_path", "Enter file path for the consumption data:",
                                    value = "C://Users//fabuhayjan//Desktop//GEMS_R.xlsx", width = "100%")
                 ),
    ...
    tabPanel("Isotopes",
             sidebarLayout(
               sidebarPanel(
                 ...
                 tags$div(style = "display:none;",
                          textInput("iso_file_path", "Enter file path for the consumption data:",
                                    value = "C://Users//fabuhayjan//Desktop//GEMS_R.xlsx", width = "100%")
                 ),
